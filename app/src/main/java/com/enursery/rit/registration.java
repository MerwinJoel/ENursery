                        ...
                        .addOnCompleteListener(registration.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (!task.isSuccessful()) {
                                    Toast.makeText(registration.this, "Registration unsuccessfull",
                                    ...
                                    registration_supplier supplier = new registration_supplier(
                                            userID, etuname.getText().toString(), email, password, "supplier"
                                    );
                                    databaseReference.child(userID).setValue(supplier);
                                    startActivity(new Intent(registration.this, supplier.class));
                                    finish();
                                }
                            }
                        });
